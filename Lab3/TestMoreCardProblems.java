...
public class TestMoreCardProblems {
    ...
    public void testHasFullHouse() {
        ...
        assertEquals(check.getValue(), 3245254618L);
    }
    ...
    public void testBridgePointCount() {
        ...
        assertEquals(check.getValue(), 1146961819L);
    }
    ...
    public void testBridgeHandShape() {
        ...
        assertEquals(check.getValue(), 1679153997L);
    }
    ...
    public void testCountDeadwood() {
        ...
        assertEquals(check.getValue(), 3688288563L);
    }
}
